...
<body>
	...
	<div class="logDiv">
		...
		<div class="logGet">
			...
			<!-- 输入框 -->
			<div class="lgD">
				<img class="img1" src="img/logName.png" /><input id="username" name="username" type="text" placeholder="输入用户名" />
			</div>
			<div class="lgD">
				<img class="img1" src="img/logPwd.png" /><input id="password" name="password" type="password" placeholder="输入用户密码" />
			</div>
			<div class="lgD logD2">
