			...
			<tr>
				<td bgcolor="#f7f7f2">
					<table width="100%" border="0" cellpadding="2" cellspacing="1">
						<tbody>
							<tr>
								<td width="12%" height="21" align="center" bgcolor="#f1ede3">类型：</td>
								<td height="21" bgcolor="#f9f9f9">&nbsp; 
									...
									发送对象：
									<select name="ito" id="ito" class="kuanglan" style="width: 200px;">
									</select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td bgcolor="#f9f9f9">&nbsp; <textarea name="context" rows="10" cols="20" id="context" class="kuanglan" style="height: 360px;">${msg.context }</textarea></td>
							</tr>
							<tr>
								<td align="center" bgcolor="#f1ede3">&nbsp;</td>
							...
							<tr>
								...
								<td bgcolor="#f9f9f9">&nbsp; <input type="button"
									...
									<input type="button" name="save" value="保存>>" id="save"></td>
							</tr>
							<tr>
								<td align="center" bgcolor="#f1ede3">&nbsp;</td>
								<td bgcolor="#f9f9f9">&nbsp;</td>
