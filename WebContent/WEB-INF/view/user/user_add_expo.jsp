	...
	$(document).ready(function() {
		...
		$("#save").click(function() {
			...
			$.ajax({
				...
				type : "post",
				url : "<%=request.getContextPath()%>/expo/${user.username }/save",
						...
						<tbody>
							<tr>
								...
								<td height="21" bgcolor="#f9f9f9">&nbsp; 
									<select name="venue" id="venue" class="kuanglan"> </select>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td bgcolor="#f9f9f9">&nbsp; <textarea name="about_organizer" rows="10" cols="20" id="about_organizer" class="kuanglan" style="height: 110px;">${expo.expo_introduction }</textarea></td>
							</tr>
							<tr>
								<td align="center" bgcolor="#f1ede3"></td>
								<td bgcolor="#f9f9f9">&nbsp;
