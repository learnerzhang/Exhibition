...
$(function(){
	$(".btn_yes").click(function(){
		...
		$.ajax({
			...
			url : "<%=request.getContextPath()%>/sys/index/changePassword",
			type : "post",
			...
			<div class="bacen">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" onblur="checkpwd3()"
						id="pwd3" /> <img class="imga" src="../../img/ok.png" /><img class="imgb" src="../../img/no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
