...
$(function(){
  ...
  initSelect();
   ...
   $("#pageList").change(function(){
		...
		self.location="<%=request.getContextPath()%>/sys/index/enterprise?page="+page;
	});
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<c:forEach items="${enterprises }" var="enterprise" varStatus="status">
							<tr>
								...
								<td><a href="<%=request.getContextPath()%>/sys/index/toUpdateEnterprise?id=${enterprise.id}&page=${page.currentPage}"><img class="operation" src="../img/update.png"></a> <img id="${enterprise.id }" class="operation delban" src="../img/delete.png"></td>
							</tr>		
						</c:forEach>
					</table>
					<div class="paging">
