	...
	$(function() {
		...
		$("#save").click(function() {
			...
			$.ajax({
				...
				type : "post",
				url : "<%=request.getContextPath()%>/hall/${user.username }/update?id="+"${hall.id }",
					...
					<table width="100%" border="0" cellpadding="2" cellspacing="1">
						<tbody>
							...
							<tr>
								...
								<td bgcolor="#f9f9f9">&nbsp; 
									<c:choose>
										<c:when test="${empty hall.locPic}">
											<div id="logo" style="display: none">
											</div>
										</c:when>
										<c:otherwise>
											<div id="logo">
												<img src="<%=request.getContextPath()%>/resources/upload/${hall.locPic}" width="441" hight="291" border="0">
											</div>
										</c:otherwise>
									</c:choose>
								</td>
							...
							<tr>
								<td align="center" bgcolor="#f1ede3"></td>
								<td width="766px" bgcolor="#f9f9f9" >&nbsp;&nbsp;</td>
							</tr>
							<tr>
