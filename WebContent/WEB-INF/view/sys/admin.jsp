					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<c:forEach items="${admins }" var="admin" varStatus="status">
							<tr height="40px">
								...
								<td>${admin.email }</td>
								<td>${fn:split(admin.c_time,'.')[0] }</td>
								<td>
									<a href="<%=request.getContextPath()%>/sys/index/updateAdmin?id=${admin.id}">
										<img class="operation" src="../img/update.png">
									</a> 
									<img onclick="del(${admin.id})" id="delban" class="operation delban" src="../img/delete.png">
								</td>
						</tr>
						</c:forEach>
					</table>
