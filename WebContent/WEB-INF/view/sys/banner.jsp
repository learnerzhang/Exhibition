...
$(function(){
	...
	$(".yes").click(function(){
		  ...
		  $.ajax({
				...
				url : "<%=request.getContextPath()%>/sys/index/delAdImage?id="+id,
				type : "post",
				dataType : "json",
	 ...
	 $("#pageList").change(function(){
			...
			self.location="<%=request.getContextPath()%>/sys/index/banner?page="+page;
		});
...
<body>
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="banner">
				<div class="add">
					<a class="addA" href="<%=request.getContextPath() %>/sys/index/banneradd">上传广告&nbsp;&nbsp;+</a>
				</div>
				<!-- banner 表格 显示 -->
				<div class="banShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<c:forEach items="${adimages }" var="adimage" varStatus="status">
							<tr>
							...
							<td>${adimage.sort }</td>
							<td>
							<a href="<%=request.getContextPath()%>/sys/index/updateAdImage?id=${adimage.id }"> <img class="operation" src="../img/update.png">
							</a>
							<img id="${adimage.id }" class="operation delban" src="../img/delete.png"></td>
						</tr>
						</c:forEach>
					</table>
					<div class="paging">
